                                            ...
                                            {contacts.map((item, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <td className="px-4 py-3 text-center">
                                                        <Tooltip content={item.is_main ? "Contato Principal" : "Definir como Principal"} position="top">
                                                            <button 
                                                                type="button" 
                                                                disabled={readOnly}
                                        ...
                                        <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
                                            {taxRegimes.map((item, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <td className="px-4 py-3 font-medium text-slate-900 dark:text-white">
                                                        <div className="flex items-center gap-2 group/copy">
                                                            <span>{TAX_REGIME_LABELS[item.regime] || item.regime}</span>
                                                            <CopyButton text={TAX_REGIME_LABELS[item.regime] || item.regime} className="opacity-0 group-hover/copy:opacity-100" />
                                                        </div>
                                                    </td>
                                        ...
                                        <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
                                            {accesses.map((item, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <td className="px-4 py-3">
                                                        {item.access_url && (
                                                            <a href={item.access_url} target="_blank" rel="noreferrer" className="group/tooltip relative text-blue-600 hover:underline flex items-center gap-1 w-fit">
                                                                Link <ExternalLink size={12} />
                                                                <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 hidden group-hover/tooltip:block w-max px-2 py-1 bg-slate-900 dark:bg-slate-800 text-white text-[10px] rounded shadow-lg z50 pointer-events-none animate-in fade-in zoom-in-95 duration-200">
                                                                    Abrir Link
                                                                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 border-[3px] border-transparent border-b-slate-900 dark:border-b-slate-800" />
                                                                </div>
                                                            </a>
                                                        )}
                                                    </td>
                                        ...
                                        <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
                                            {dfeSeries.map((item, index) => (
                                                <tr key={index}>
                                                    ...
                                                    <td className="px-4 py-3">
                                                        {item.login_url ? (
                                                            <a href={item.login_url} target="_blank" rel="noreferrer" className="group/tooltip relative text-blue-600 hover:underline flex items-center gap-1 w-fit">
                                                                Link <ExternalLink size={12} />
                                                                <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 hidden group-hover/tooltip:block w-max px-2 py-1 bg-slate-900 dark:bg-slate-800 text-white text-[10px] rounded shadow-lg z50 pointer-events-none animate-in fade-in zoom-in-95 duration-200">
                                                                    Abrir Link
                                                                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 border-[3px] border-transparent border-b-slate-900 dark:border-b-slate-800" />
