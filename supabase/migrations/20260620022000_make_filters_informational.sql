-- Migração para remover os filtros de regime tributário e setor da lógica de disparo automático
-- Mantendo a coluna no banco e no formulário, mas ignorando-os no processamento automático de templates.
